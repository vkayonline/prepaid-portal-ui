...
function DraftRow({ id, applicationName, date, status, updatedBy }: Draft) {
  return (
    <TableRow>
      <TableCell>
...
export function DraftsTable() {
  ...
  useEffect(() => {
    apiClient.getDrafts().then(setData);
  }, []);
        ...
        <Table>
          ...
          <TableBody>
            {data === null ? (
              ...
              currentData.map((draft) => <DraftRow key={draft.id} {...draft} />)
            )}
          </TableBody>
        </Table>
      </div>
